...
class StoreConfigSeoRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'title'         =>  'required|min:2|unique:config_seos,title,'.($this->id ?? ''),
            'seo_title'     =>  'required'
        ];
    }
    ...
    public function attributes() {
        return [
            'title'         =>  __('Tên Seo Website'),
            'seo_title'     =>  __('Tiêu Đề Website'),
        ];
    }
}
