...
@if( !empty( $product_for_you ) && count( $product_for_you ) > 0 ) )
    <div class="product-area pt-30 pb-45">
    <div class="container">
        <div class="section-border mb-10">
            <h1 class="section-title section-bg-white">Sản Phẩm Dành Cho Bạn</h1>
        </div>
        ...
        <div class="headphone-slider-active owl-carousel product-slider">
            @foreach($product_for_you as $key => $item)
                @php
