                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="cart-shiping-update-wrapper">
                                        ...
                                        <a href="{{ $data->url }}" style="color:#df2121;display:block;font-size:16px" class="continue-buy mb-2">Tiếp tục mua hàng
                                            <i style="font-size:16px" class="fa fa-arrow-circle-o-right" aria-hidden="true"></i>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    <form action="{{ route('update-to-cart') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="cart-shiping-update-wrapper" style="display:flex;justify-content:space-between;">
                                                    <span class="delete-cart" style="color: #df2121;font-size:16px">
                                                        <i style="font-size:16px" class="fa fa-times" aria-hidden="true"></i>
                                                        Xoá toàn bộ giỏ hàng
                                                    </span>
                                                    <div class="cart-clear">
                                                        <div class="grand-totall">
                                                            <h4 class="grand-totall-title" style="background:#df2121">TỔNG TIỀN: <span> {{ number_format($cart_total_price, 0, ".", ".") }}đ</span></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="checkout-area pb-45 pt-65">
                                                <form id="form-infomation" action="{{ route('order') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
                                                    ...
                                                    <div class="row" style="display: flex">
                                                        <div class="col-lg-6 pr-3" style="flex-grow: 0.5">
                                                            <h4>Thông Tin Mua Hàng</h4>
                                                            <div class="billing-info">
                                                                <input name="name" type="text" class="form-control w-100 mb-2" placeholder="Họ tên (*)" required>
                                                            </div>
                                                            <div class="billing-info">
                                                                <input name="phone" type="text" class="form-control w-100 mb-2" placeholder="Số điện thoại (*)" required>
                                                            </div>
                                                            <div class="billing-info">
                                                            ...
                                                            <div class="billing-info">
                                                                <textarea name="note" class="form-control w-100 mb-2" placeholder="Thông tin (*)" rows="3" required></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 pl-3" id="list-pay-method" style="flex-grow: 0.5">
