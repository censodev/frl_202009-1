		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_product_selling" name="title_product_selling" value="{{ $home_default->title_product_selling ?? old('title_product_selling') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>

		  <div id="holder-product-selling" class="thumbnail holder-thumbnail text-center">
			@if( !empty( $home_default->images_product_selling ) )
			  <img src="{{ $home_default->images_product_selling }}" style="height: 5rem;">
			@endif
		  </div>
		  <div class="input-group">
			...
			<input id="thumbnail-product-selling" class="form-control" type="text" name="images_product_selling" value="{{ $home_default->images_product_selling }}">
		  </div>

		  <div class="form-group mt-3">
			<label for="content_product_selling">Nội Dung</label>
			<textarea id="content_product_selling" name="content_product_selling" class="form-control ckeditor-lfm" rows="4">{!! $home_default->content_product_selling ?? old('content_product_selling') !!}</textarea>
		  </div>

			<div class="form-group block-search-appliesto">
			  <label for="seo_title">Chọn Sản Phẩm ( Những Sản Phẩm Giảm Giá)</label><br/>
