...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control" required placeholder="Nhập tên bộ sưu tập" oninvalid="this.setCustomValidity('Vui lòng nhập tên bộ sưu tập.')" oninput="setCustomValidity('')">
                  @if( $errors->has('title') )
                ...
                <div class="form-group">
                  ...
                  <textarea id="sapo" name="sapo" class="form-control" rows="4">{!! old('sapo') !!}</textarea>
                </div>
