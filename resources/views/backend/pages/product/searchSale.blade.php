...
@else
	<div class="modal fade" id="modal-lg-product-sale">
		    ...
		    <div class="modal-content">
		      	...
		      	<div class="modal-body">
		        	<form action="" id="formAddItem" method="post">
						<div class="input-group block-search-appliesto inProductSale">
		                  	<input type="text" class="form-control">
		                  	<span class="input-group-append">
		                    	<button type="button" class="btn btn-info btn-flat product_search" search="inProductSale" is-append="1">Tìm Kiếm</button>
		                  	</span>
		                </div>

		                <div class="block-product-sale-list">
							<ul class="todo-list" data-widget="todo-list">
								@foreach($products as $key => $product)
									@php
