...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('seeding.update',$seeding->id) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-12">
                  ...
                  <div class="row mt-1rem">
                      ...
                      <div class="col-md-3">
                          <div class="form-group">
                              ...
                              <input type="text" name="time" placeholder="Nhập thời gian" class="form-control" value="{{ $seeding->time ?? old('time') }}">
                          </div>
                      </div>
                  </div>
