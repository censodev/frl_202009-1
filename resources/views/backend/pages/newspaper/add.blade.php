...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('newspaper.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên báo chí" oninvalid="this.setCustomValidity('Vui lòng nhập tênbáo chí.')" oninput="setCustomValidity('')">
                  @if( $errors->has('name') )
