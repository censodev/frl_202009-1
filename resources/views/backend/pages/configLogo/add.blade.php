...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('configLogo.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" id="title" name="title" value="{{ old('title') }}" class="form-control" required placeholder="Nhập tên logo" oninvalid="this.setCustomValidity('Vui lòng nhập tên logo.')" oninput="setCustomValidity('')">
                  @if( $errors->has('title') )
                ...
                <div class="input-group">
                  ...
                  <input id="thumbnail" class="form-control" type="text" name="images" required readonly oninvalid="this.setCustomValidity('Vui lòng chọn logo.')" oninput="setCustomValidity('')">
                </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control custom-select" name="type">
                    ...
                    <option value="1">Top Header</option>
                    <option value="2">Footer</option>
					<option value="3">Favicon</option>
                  </select>
                </div>
