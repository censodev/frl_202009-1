		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_product_hot" name="title_product_hot" value="{{ $homepageManager->title_product_hot ?? old('title_product_hot') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>

		  <div id="holder-product-hot" class="thumbnail holder-thumbnail text-center">
			@if( !empty( $homepageManager->images_product_hot ) )
			  <img src="{{ $homepageManager->images_product_hot }}" style="height: 5rem;">
			@endif
		  </div>
		  <div class="input-group">
			...
			<input id="thumbnail-product-hot" class="form-control" type="text" name="images_product_hot" value="{{ $homepageManager->images_product_hot }}">
		  </div>

		  <div class="form-group mt-3">
			<label for="content_product_hot">Nội Dung</label>
			<textarea id="content_product_hot" name="content_product_hot" class="form-control ckeditor-lfm" rows="4">{!! $homepageManager->content_product_hot ?? old('content_product_hot') !!}</textarea>
		  </div>
