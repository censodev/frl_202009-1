		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_news" name="title_news" value="{{ $homepageManager->title_news ?? old('title_news') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>
		  ...
		  <div class="input-group">
			...
			<input id="thumbnail-news" class="form-control" type="text" name="images_news" value="{{ $homepageManager->images_feedback }}" readonly>
		  </div>
