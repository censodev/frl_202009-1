		...
		<div class="card-body">
		  ...
		  <div class="form-group">
			...
			<div class="input-group">
			  ...
			  <input type="text" id="title_team" name="title_team" value="{{ $homepageManager->title_team ?? old('title_team') }}" class="form-control" placeholder="Tiêu Đề">
			</div>
		  </div>

		  <div id="holder-team" class="thumbnail holder-thumbnail text-center">
			@if( !empty( $homepageManager->images_team ) )
			  <img src="{{ $homepageManager->images_team }}" style="height: 5rem;">
			@endif
		  </div>
		  <div class="input-group">
			...
			<input id="thumbnail-team" class="form-control" type="text" name="images_team" value="{{ $homepageManager->images_team }}" readonly>
		  </div>
