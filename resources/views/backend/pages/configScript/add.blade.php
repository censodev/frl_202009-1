...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('configScript.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <textarea id="script_head" name="script_head" class="form-control ckeditor-lfm" rows="4"></textarea>
                </div>

                <div class="form-group">
                  <label for="script_body">Chèn Script, Style ngay dưới thẻ body</label>
                  <textarea id="script_body" name="script_body" class="form-control ckeditor-lfm" rows="4"></textarea>
                </div>

                <div class="form-group">
                  <label for="script_footer">Chèn Script, Style dưới footer</label>
                  <textarea id="script_footer" name="script_footer" class="form-control ckeditor-lfm" rows="4"></textarea>
                </div>
