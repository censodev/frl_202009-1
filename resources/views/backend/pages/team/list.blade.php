              ...
              <tbody>
                  ...
                  @foreach($teams as $key => $team)
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="{{ route('team.edit',$team->id) }}"> {{ $team->name }} </a>
                      </td>
                      <td>
                        {{ $team->position }}
                      </td>
                      ...
                      <td class="project-actions text-right">
                        <a class="btn btn-primary btn-sm hide" href="{{ route('team.show',$team->id) }}">
                          <i class="fas fa-folder"></i> Xem
                        </a>
                        <a class="btn btn-info btn-sm" href="{{ route('team.edit',$team->id) }}">
                          <i class="fas fa-pencil-alt"></i> Sửa
                        </a>
                        <button type="button" class="btn btn-danger btn-sm deleteItemModal" data-toggle="modal" data-target="#modal-danger-delete" data-id="{{ $team->id }}" data-url="admin/team/{{ $team->id }}">
