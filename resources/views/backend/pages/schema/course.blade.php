...
@section('content')
    ...
    @php
        if( !empty($data['schema_course'])){
            $schema = $data['schema_course'];
    ...
    <section class="content">
        <form role="form" action="{{ route('post_schema_course') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
            @csrf
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_cource" value="{{ $data_schema['name_cource'] ?? old('name_cource') }}" class="form-control" required placeholder="Nhập tên khoá học" oninvalid="this.setCustomValidity('Vui lòng nhập tên khoá học.')" oninput="setCustomValidity('')">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả Khoá Học</label>
                                        <textarea name="description_cource" class="form-control ckeditor" required placeholder="Nhập mô tả khoá học" oninvalid="this.setCustomValidity('Vui lòng nhập mô tả khoá học.')" oninput="setCustomValidity('')">
                                            {!! $data_schema['description_cource'] ?? old('description_cource') !!}
                                        </textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Tác giả (Nhà phát hành)</label>
                                        <input type="text" name="name_organization" value="{{ $data_schema['name_organization'] ?? old('name_organization') }}" class="form-control" required placeholder="Nhập tên tác giả, nhà phát hành" oninvalid="this.setCustomValidity('Vui lòng nhập tên tác giả, nhà phát hành')" oninput="setCustomValidity('')">
                                    </div>
                                    <div class="form-group">
                                        <label> Url Tác giả (Nhà phát hành)</label>
                                        <input type="text" name="url_organization" value="{{ $data_schema['url_organization'] ?? old('url_organization') }}" class="form-control" required placeholder="Nhập url tác giả, nhà phát hành" oninvalid="this.setCustomValidity('Vui lòng nhập url tác giả, nhà phát hành.')" oninput="setCustomValidity('')">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="type">Breadcrumb Khoá Học</label>
