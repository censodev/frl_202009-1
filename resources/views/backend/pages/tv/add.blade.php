...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('tv.store') }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        <div class="row">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-control" required placeholder="Nhập tên truyền hình" oninvalid="this.setCustomValidity('Vui lòng nhập tên truyền hình.')" oninput="setCustomValidity('')">
                  @if( $errors->has('name') )
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" name="name_video" value="{{ old('name_video') }}" class="form-control" required placeholder="Nhập tên video" oninvalid="this.setCustomValidity('Vui lòng nhập tên video.')" oninput="setCustomValidity('')">
                ...
                <div class="row mt-1rem">
                  ...
                  <div class="form-group">
                      ...
                      <textarea id="description" name="description" class="form-control" rows="4" value="{{ old('description') }}" required></textarea>
                  </div>
