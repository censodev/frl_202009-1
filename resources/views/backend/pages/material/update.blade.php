...
@section('content')
    ...
    <section class="content">
      <form role="form" action="{{ route('material.update',$material->id) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
        @csrf
        @method('PUT')
        <div class="row">
          <div class="col-md-12">
                  ...
                  <div class="card-body">
                      <div class="col-md-6">
                          <div class="form-group">
                              <label>Tên màu</label>
                              <input type="text" name="name" value="{{ $material->name ?? old('name') }}" placeholder="Nhập tên màu" class="form-control" required>
                          </div>
                      </div>
                  </div>
              </div>
